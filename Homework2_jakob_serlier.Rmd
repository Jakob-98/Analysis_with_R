...
#so my initial thought was to use this code, but this doesn't use negative indexes:
(non_NA_age <- age[which(!is.na(age))])

#I'm not sure if this is the way you wanted us to solve it, but it seems more counterintuitive than just using the *not* operator. 
(non_NA_age <- age[-which(is.na(age))])
